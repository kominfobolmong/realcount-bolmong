        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-users"></i> Sosial Media</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            @forelse ($sosmeds as $no => $sosmed)
                                <tr>
                                    <th scope="row" style="text-align: center">{{ ++$no + ($sosmeds->currentPage()-1) * $sosmeds->perPage() }}</th>
                                    <td>{{ $sosmed->name }}</td>
                                    <td>{{ $sosmed->url }}</td>
                                    <td>{{ $sosmed->icon }}</td>
                        ...
                        <div style="text-align: center">
                            {{$sosmeds->links("vendor.pagination.bootstrap-4")}}
                        </div>
                    </div>
                </div>
            </div>
